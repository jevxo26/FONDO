    ...
    <section className="py-8 lg:py-12 bg-background">
      <div className="wrapper">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          {/* Left Block: Main Product Image Gallery */}
          <div className="lg:col-span-6">
            <div className="relative aspect-4/3 w-full overflow-hidden rounded-[32px] bg-muted shadow-[var(--shadow-card)]">
              <Image
                src="https://picsum.photos/id/431/600/450"
                alt="Hand selected mutton sealed with aged basmati"
                fill
                priority
          ...
          {/* Right Block: Content Details & Purchasing Actions */}
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="flex size-9 items-center justify-center rounded-full bg-white text-foreground shadow-sm hover:text-destructive dark:bg-card">
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <div className="flex items-center border border-border bg-white rounded-xl overflow-hidden dark:bg-card">
                <button 
                  ...
                  className="p-2.5 text-muted-foreground hover:bg-muted"
                >
                  <Minus className="size-3.5" />
                </button>
                <span className="w-10 text-center font-sans text-sm font-semibold text-foreground">
                  {quantity}
                </span>
                <button 
            ...
            <button className="mt-4 flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-[#CEA359]/70 font-sans text-sm font-semibold text-[#1B0E08] transition-colors hover:bg-[#CEA359]/80">
              <MessageSquare className="size-4" /> Order Directly via WhatsApp
            </button>
          </div>
