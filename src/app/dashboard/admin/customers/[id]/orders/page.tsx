...
import { useAdminCustomerOrders } from "@/store/api/slices/admin-customers-api";
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-center gap-3">
        <h1 className="font-heading text-2xl font-bold text-foreground">Customer Orders</h1>
