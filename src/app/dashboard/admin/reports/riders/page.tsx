...
export default function ReportsRidersPage() {
  ...
  const onTimeRate =
    totalDeliveries > 0 ? Math.round(((totalDeliveries - totalLate) / totalDeliveries) * 100) : 0;
    ...
    <div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          label="On-Time Rate"
          value={`${onTimeRate}%`}
          variant={onTimeRate > 90 ? "success" : "warning"}
          icon={Award}
          accent="right"
        />
        <StatCard
      ...
      <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <GlassCard
          ...
          title="Top Rider"
          value={topRider.riderName}
          subtitle={`${topRider.deliveries} deliveries`}
          className="flex-1"
        >
