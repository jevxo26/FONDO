...
import { PendingTableSection } from "@/components/dashboard/admin/vendors/pending-table-section";
import { PendingVendorSummaryCards } from "@/components/dashboard/admin/vendors/pending-vendor-summary-cards";
