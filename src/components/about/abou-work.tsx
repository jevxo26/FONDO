  ...
  return (
    <section className="py-16 bg-[#F3ECE0] border-t border-b border-[#16100C]/5 text-center">
      <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-10">
        <h2 className="font-fraunces text-2xl md:text-3xl font-normal text-[#16100C]">How It Works</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, idx) => (
            <div key={idx} className="space-y-3 relative">
              ...
              <h4 className="font-fraunces text-sm font-medium text-[#16100C]">{step.title}</h4>
