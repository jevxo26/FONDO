  ...
  const advantages = [
    {
      ...
      desc: "Every meal is prepared fresh day of delivery using fresh local market ingredients.",
      icon: <Utensils />,
    },
    {
      title: "Perfect Macro Ratios",
      desc: "Precision portion controls that match specialized fitness and diet standards.",
      icon: <Target />,
    },
    {
      title: "Nutrition Advisor",
      desc: "Expert nutrition advice to align protein intake for your specific training goals.",
      icon: <Heart />,
    },
    {
      title: "Premium Meal Plans",
      desc: "Varied menus designed by experienced fine-dining kitchen master chefs.",
      icon: <Award />,
    },
    {
      title: "Flexible Subscription",
      desc: "Pause, skip, or modify active plan intervals without hidden fee penalties.",
      icon: <Calendar />,
    },
    {
      title: "Daily Delivery",
      desc: "Tightly coordinated morning drops direct to home or corporate spaces.",
      icon: <Truck />,
    },
    {
      title: "Easy Customization",
      desc: "Your ingredients or allergen settings can be modified easily inside your client profile.",
      icon: <Sliders />,
    },
    {
      title: "Safe Online Payments",
      desc: "Fully secure transactions via encrypted local and international gateways.",
      icon: <Shield />,
    },
  ];
