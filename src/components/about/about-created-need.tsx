...
export default function CateredNeeds() {
  const needs = [
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1498837167922-ddd27525d352?q=80&w=400",
    },
    {
      name: "Office Meal",
    ...
    {
      name: "Vegetarian",
      img: "https://images.unsplash.com/photo-1540420773420-3366772f4999?q=80&w=400",
    },
    {
      name: "Vegan",
      img: "https://images.unsplash.com/photo-1511690656952-34342bb7c2f2?q=80&w=400",
    },
  ];
  ...
  return (
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-12">
        <h2 className="font-heading text-2xl md:text-4xl text-center font-normal text-foreground">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {needs.map((item, idx) => (
            <div
              key={idx}
              className="relative aspect-[4/3] rounded-2xl overflow-hidden group shadow-sm border border-foreground/10"
            >
              <Image
                width={500}
                height={500}
