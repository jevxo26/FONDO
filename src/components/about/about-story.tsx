        ...
        <div className="lg:col-span-7 space-y-6 lg:pl-8">
          ...
          <div className="font-sans text-sm text-[#16100C]/75 space-y-4 leading-relaxed font-light">
            <p>
              ...
              an uphill battle when operating in modern ecosystems.
            </p>
            <p>
              We saw the gap between professional kitchens and healthy home nutrition. The problem
              wasn&apos;t lack of desire, but a lack of &ldquo;accessible nutrition&rdquo; that fits
              into execution schedules.
            </p>
            <p>
              Food Flow was born to bridge this gap, allowing the modern professional to deliver
              authentic and standard nutritional values to the body without losing single seconds of
              preparation time.
            </p>
          </div>
        </div>
