    ...
    <section className="py-20 bg-[#FAF5EB] border-b border-[#16100C]/5">
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <h2 className="font-fraunces text-3xl font-normal text-[#16100C]">Certified Kitchen Partners</h2>
          ...
          <div className="border border-[#16100C]/10 rounded-2xl p-5 bg-[#FAF5EB] italic font-fraunces text-xs text-[#16100C]/80 leading-relaxed font-light">
        ...
        <div className="lg:col-span-6 space-y-6 lg:pl-6">
          <h2 className="font-fraunces text-2xl font-normal text-[#16100C]">Growing Presence</h2>
