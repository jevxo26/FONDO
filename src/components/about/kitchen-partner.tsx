    ...
    <section className="py-20 bg-[#FAF5EB] border-b border-[#16100C]/5">
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <h2 className="font-heading text-3xl font-normal text-[#16100C]">
        ...
        <div className="lg:col-span-6 space-y-6 lg:pl-6">
          ...
          <div className="space-y-3">
            {regions.map((reg, idx) => (
              <div
                key={idx}
                className="flex items-center justify-between p-4 bg-white border border-[#16100C]/5 rounded-xl shadow-sm"
              >
