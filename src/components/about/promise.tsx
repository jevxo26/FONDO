  ...
  const promises = [
    {
      ...
      desc: "No frozen meats or chemical preservatives used.",
      icon: <Leaf />,
    },
    {
      title: "Daily Preparation",
      desc: "Our kitchens run 24/7 to secure fresh meals daily.",
      icon: <Clock />,
    },
    {
      title: "Hygienic Kitchen",
      desc: "Strictly sanitized environments conforming to safety standards.",
      icon: <Sparkles />,
    },
    {
      title: "Balanced Nutrition",
      desc: "Scientific macros formulated by certified nutritionists.",
      icon: <Scale />,
    },
    {
      title: "Smart Packaging",
      desc: "Biodegradable, microwave-safe eco box design layouts.",
      icon: <Box />,
    },
    {
      title: "Quality Checked",
      desc: "Pre-dispatch inspections for taste and safety parameters.",
      icon: <CheckCircle />,
    },
  ];
