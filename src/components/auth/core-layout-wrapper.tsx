  ...
  return (
    ...
    >
      ...
      <div className="relative hidden lg:flex flex-col justify-end p-12 bg-foreground overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,color-mix(in_srgb,var(--primary)_15%,transparent)_0%,transparent_70%)]" />
        <Image
          src={
            isIdentityFlow
