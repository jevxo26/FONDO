    ...
    <div className="bg-white rounded-[24px] border border-border/40 p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {[
          ...
          { id: "pickup", label: "Pick up", desc: "Collect directly from kitchen", icon: ShoppingBag },
        ].map((opt) => {
          const Icon = opt.icon;
          ...
          return (
            ...
            >
              <div className={`p-2.5 rounded-xl ${isSelected ? "bg-primary/20" : "bg-white border"}`}>
              ...
              <div>
                ...
                <p className={`font-sans text-xs ${isSelected ? "text-neutral-300" : "text-muted-foreground"}`}>
                  {opt.desc}
                </p>
              </div>
            </button>
