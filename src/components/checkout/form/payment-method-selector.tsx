            ...
            <Tooltip key={method.id}>
              <TooltipTrigger>
                <Button
                  ...
                  className={`relative flex flex-col items-center justify-center p-4 rounded-xl transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] text-center min-h-[84px] ${
                    isSelected
                ...
                >
                  {isSelected && (
                    <div className="absolute top-1.5 right-1.5 size-4 bg-primary rounded-full flex items-center justify-center shadow-[0_0_8px_color-mix(in_srgb,var(--primary)_30%,transparent)]">
