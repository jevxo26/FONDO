...
export function FormSectionCard({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -top-3 -left-3 size-20 rounded-full bg-primary/5 blur-2xl" />
      <div className="pointer-events-none absolute -top-8 -right-8 size-28 rounded-full bg-primary/5 blur-2xl" />
