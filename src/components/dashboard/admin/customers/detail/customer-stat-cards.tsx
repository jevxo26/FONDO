...
export default function CustomerStatCards({ totalOrders, totalSpent, totalSubscriptions, totalPayments }: CustomerStatCardsProps) {
  return (
    <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
      <StatCard label="Total Orders" value={totalOrders} icon={ShoppingBag} accent="bottom" />
      <StatCard label="Total Spent" value={`৳${totalSpent.toLocaleString()}`} icon={CreditCard} accent="bottom" />
