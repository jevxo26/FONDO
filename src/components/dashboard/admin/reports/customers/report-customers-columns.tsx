...
export const customerReportColumns: ColumnDef<CustomerReportEntry>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <span className="text-sm text-muted-foreground">
        ৳{row.original.avgOrderValue.toLocaleString()}
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <span className="text-sm text-muted-foreground">{row.original.lifetimeDays} days</span>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <span className="text-sm text-muted-foreground">{row.original.lastOrderDate}</span>
    ),
  },
];
