...
import { PhoneCall, ShieldCheck, Clock, ChevronRight } from "lucide-react";
...
export function EmergencyContactCard({ isVerified, onOpenModal }: { isVerified: boolean; onOpenModal: () => void }) {
    return (
        <div
            onClick={onOpenModal}
        ...
        >
            ...
            <div className="mt-5 pl-2">
                ...
                <p className="mt-1 line-clamp-2 text-xs text-muted-foreground">Primary kin details, address, and mobile number.</p>
            </div>
...
export function EmergencyModalContent({ data }: { data: EmergencyContact }) {
    return (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <DetailBlock label="Contact Name" value={data.contactName} />
            <DetailBlock label="Relationship" value={data.relationship} />
