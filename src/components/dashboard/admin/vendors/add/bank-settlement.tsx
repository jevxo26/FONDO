...
export const mockBankSettlement: BankSettlement = {
    bankName: "City Bank PLC",
    accountTitle: "Gourmet Kitchen Private Limited",
    accountNumber: "310.2984.0019",
    branchName: "Gulshan Avenue Branch",
    routingNumber: "225261890",
    settlementCycle: "Daily Auto-Settlement (T+1)",
};

export function BankSettlementCard({ isVerified, onOpenModal }: { isVerified: boolean; onOpenModal: () => void }) {
    return (
        <div
            onClick={onOpenModal}
        ...
        >
            ...
            <div className="mt-5 pl-2">
                ...
                <p className="mt-1 line-clamp-2 text-xs text-muted-foreground">Payout account details, routing codes, and schedules.</p>
            </div>
...
export function BankModalContent({ data }: { data: BankSettlement }) {
    return (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <DetailBlock label="Bank Name" value={data.bankName} />
            <DetailBlock label="Account Title" value={data.accountTitle} />
            ...
            <DetailBlock label="Payout Cycle" value={data.settlementCycle} />
        </div>
    );
}
