...
export function StatCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "pointer-events-none absolute -right-8 -top-8 size-36 rounded-full opacity-60 blur-3xl",
          orbStyles[variant],
        )}
      />
      <div className={cn("relative z-10 p-5", pos.pad)}>
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            <p className="font-heading text-[30px] font-bold leading-tight tracking-tighter text-foreground drop-shadow-[0_1px_1px_rgba(0,0,0,0.03)]">
              {value}
            </p>
          ...
          <div
            className={cn(
              "mt-0.5 flex size-10 shrink-0 items-center justify-center rounded-xl shadow-sm ring-1",
