...
const activeButtonClass =
  "border-l-[3px] border-primary bg-gradient-to-r from-primary/10 to-primary/5 shadow-[inset_0_1px_1px_color-mix(in_srgb,var(--primary)_15%,transparent),0_0_16px_color-mix(in_srgb,var(--primary)_12%,transparent)] font-semibold text-primary";
...
const activeChildClass =
  "font-semibold text-primary shadow-[inset_0_1px_1px_color-mix(in_srgb,var(--primary)_10%,transparent),0_0_12px_color-mix(in_srgb,var(--primary)_8%,transparent)] bg-gradient-to-r from-primary/8 to-primary/3";
          ...
          <li key={child.href} className="relative flex items-center">
            ...
            <div
              className={cn(
                ...
                isActive ? "bg-primary shadow-[0_0_8px_color-mix(in_srgb,var(--primary)_40%,transparent)]" : "bg-primary/40",
              )}
