      ...
      <div className="wrapper space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="font-sans italic text-sm md:text-base text-muted-foreground leading-relaxed">
            &ldquo;Sovereign taste is not an accident; it is a meticulous pact made with time,
            flame, and soil.&rdquo;
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-card border border-border/60 rounded-2xl p-8 flex flex-col justify-between space-y-6 shadow-[var(--shadow-card)] transition-transform duration-300 hover:-translate-y-1">
            <div className="space-y-4">
              ...
              <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed">
                We reject the modern rush. Our hearths simmer slowly for up to twelve hours,
                allowing raw, wild spices to release their deepest, mature oils naturally.
              </p>
            </div>
          ...
          <div className="bg-primary text-primary-foreground rounded-2xl p-8 flex flex-col justify-between space-y-6 shadow-[var(--shadow-badge)] transition-transform duration-300 hover:-translate-y-1">
            <div className="space-y-4">
              ...
              <h3 className="font-heading text-xl font-normal">Artisanal Precision</h3>
              <p className="font-sans text-xs md:text-sm opacity-90 leading-relaxed">
                Every grain of heritage rice, hand-measured whole cardamom, and gold saffron strand
                is balanced to the micro-gram according to our ancestral formulas.
              </p>
            </div>
          ...
          <div className="bg-card border border-border/60 rounded-2xl p-8 flex flex-col justify-between space-y-6 shadow-[var(--shadow-card)] transition-transform duration-300 hover:-translate-y-1">
            <div className="space-y-4">
              ...
              <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed">
                We source exclusively from local, non-hybrid bio-farms that respect crop rotation
                cycles, ensuring raw herbs arrive packed with unmatched trace nutrients.
              </p>
            </div>
            <span className="text-[10px] uppercase font-bold tracking-widest text-primary/80">
              Pure Provenance
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
            ...
            <div className="space-y-2 flex-1 text-center md:text-left">
              ...
              <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed max-w-3xl">
                Moments before your clay cells are sealed, our chefs drop a fresh-steeped
                concentrate of hand-selected Iranian Saffron threads into the center of the dish,
                locking in aromatic vapor that blooms only upon opening.
              </p>
            </div>
          </div>
        </div>
