      ...
      <div className="wrapper grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="space-y-4 text-xs md:text-sm text-muted-foreground font-sans leading-relaxed">
            <p>
              For over a century, our family has guarded the sacred culinary scrolls of legendary
              royal kitchens. What began as a single slow-fire hearth in 1924 has matured into a
              timeless sanctuary of gastronomic art, preserving the complex alchemy of fresh-milled
              spices and traditional techniques.
            </p>
            <p>
              Every dish we assemble is a meticulous translation of living history. We do not rush
              the fire; our heritage dictates a patient, hours-long simmering process that coaxes
              the absolute deepest essences from hand-ground cardamom, premium saffron threads, and
              locally harvested heirloom ingredients.
            </p>
          </div>
        </div>
