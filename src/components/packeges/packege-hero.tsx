  ...
  return (
    <header className="relative bg-secondary/50 py-16 lg:py-20 overflow-hidden border-b border-border">
      <div className="wrapper relative z-10 flex flex-col items-center text-center">
        ...
        <div className="w-full max-w-xl bg-card border border-border rounded-2xl shadow-sm mt-8 p-2 flex items-center focus-within:ring-2 focus-within:ring-primary/40 transition-all">
          ...
          <input
            ...
            className="w-full h-10 px-3 bg-transparent text-xs border-none outline-none text-foreground placeholder:text-muted-foreground"
          />
        </div>
      </div>
    </header>
