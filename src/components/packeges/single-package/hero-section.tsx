      ...
      <div className="relative h-[400px] lg:h-[480px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-6 lg:p-10 w-full space-y-3 text-white">
          <div className="flex items-center gap-2">
            ...
            <span className="bg-white/10 backdrop-blur px-3 py-1 rounded-full text-[9px] font-bold text-white uppercase tracking-[0.15em]">
              High Protein
            </span>
          </div>
          ...
          <p className="text-background/80 font-sans text-xs sm:text-sm max-w-2xl leading-relaxed">
            Precision-balanced culinary heritage designed for sustainable weight management. Every
            meal is a symphony of local ingredients and nutritional science.
          </p>
          <div className="flex items-center gap-6 pt-2">
            <div className="flex items-center gap-1.5 text-xs">
              ...
              <span className="font-semibold">
                4.9 <span className="text-white/60 font-normal">(120+ reviews)</span>
              </span>
            </div>
            ...
            <div className="text-xs">
              ...
              <span className="text-base font-bold ml-0.5">
                ৳380<span className="text-[10px] font-normal text-white/60">/meal</span>
              </span>
            </div>
          </div>
        </div>
