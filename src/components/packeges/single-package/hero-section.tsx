...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden rounded-[2rem] bg-white border border-[#d7c3b2]/30 group shadow-sm">
      <div className="relative h-[400px] lg:h-[480px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#1e1b17]/90 via-[#1e1b17]/40 to-transparent" />
        
        <div className="absolute bottom-0 left-0 p-6 lg:p-10 w-full space-y-3 text-white">
          <div className="flex items-center gap-2">
            <span className="bg-[#d9933d] text-[#533000] px-3.5 py-1 rounded-full text-[9px] font-bold uppercase tracking-[0.15em]">Premium Choice</span>
          ...
          <h1 className="font-serif text-3xl lg:text-5xl font-normal leading-tight">Signature Slim-Down</h1>
          ...
          <div className="flex items-center gap-6 pt-2">
            <div className="flex items-center gap-1.5 text-xs">
              <div className="flex text-[#d9933d]"><Star className="size-3.5 fill-current" /></div>
