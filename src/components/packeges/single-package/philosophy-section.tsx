    ...
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center bg-card border border-border/20 rounded-3xl p-6 lg:p-8 shadow-sm">
      <div className="md:col-span-2 space-y-3">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          Our methodology honors time-tested, slow-fire culinary traditions while respecting modern
          dietary profiles. By combining ancestral cooking vessels with exact macronutrient
          allocation, we preserve flavor depth and trace minerals without adding excess fats.
        </p>
