    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="font-sans text-[11px] text-muted-foreground/70 mt-1">
          Review active sessions and revoke access if suspicious.
        </p>
      </div>
        ...
        <div className="flex items-center justify-between p-4 border border-border rounded-xl bg-card">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[8px] bg-success/10 text-success font-bold tracking-wider uppercase px-1.5 py-0.5 rounded mt-0.5 inline-block">
                Current Session
              </span>
            </div>
          </div>
