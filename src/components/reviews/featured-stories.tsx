      ...
      <div className="wrapper space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-6 bg-card border border-border/60 rounded-2xl p-8 flex flex-col justify-between shadow-[var(--shadow-card)]">
            <div className="space-y-6">
              ...
              <blockquote className="font-heading text-lg md:text-xl text-foreground leading-relaxed font-light italic">
                &ldquo;As a Weight Loss Subscriber, I&apos;ve tried many services, but Food Flow is
                the first that actually feels like a restaurant experience at home. The meals are
                incredibly fresh, and the on-time delivery means I never miss a scheduled breakfast
                or dinner framework.&rdquo;
              </blockquote>
            </div>
            <div className="flex items-center gap-3 pt-6 border-t border-border/40 mt-6">
              ...
              <div>
                ...
                <p className="font-sans text-[10px] text-muted-foreground uppercase tracking-wider">
                  30-Day Lean Nutrition Framework
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              {
                img: "https://images.unsplash.com/photo-1543353071-10c8ba85a904?q=80&w=500",
                label: "Traditional Dinner Unboxing",
              },
              {
                img: "https://images.unsplash.com/photo-1498837167922-ddd27525d352?q=80&w=500",
                label: "Mughal Macro Customization",
              },
            ].map((video, idx) => (
              <div
                key={idx}
                className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-border group shadow-[var(--shadow-card)] bg-card"
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={video.img}
