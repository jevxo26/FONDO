  ...
  const sampleReviews = [
    {
      name: "Asif Nehal",
      initials: "AN",
      text: "The compliance is unmatched. Every single container delivers the exact macro profile stated on the dashboard grid. The wild herbs and slow-simmered fish recipes changed my perspective on dietary frameworks.",
      date: "Yesterday",
    },
    {
      name: "Maisha Kabir",
      initials: "MK",
      text: "Perfect timing cycle execution! Packages arrive exactly at 6:45 AM daily inside sterile eco-cells. Customizing spice tolerances via the engine works flawlessly.",
      date: "3 days ago",
    },
    {
      name: "Zayan Ahmed",
      initials: "ZA",
      text: "Truly a premium setup. Paying for the 30-day framework upfront saved time, and the trace mineral retention makes a noticeble difference in physical energy logs.",
      date: "1 week ago",
    },
  ];
      ...
      <div className="wrapper space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {sampleReviews.map((rev, idx) => (
            <div
              key={idx}
              className="bg-card border border-border/60 rounded-2xl p-6 shadow-[var(--shadow-card)] flex flex-col justify-between space-y-4"
            >
