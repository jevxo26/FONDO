        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {points.map((pt, idx) => (
            ...
            >
              ...
              <div>
                <h4 className="font-sans text-xs font-bold text-foreground tracking-tight">
                  {pt.title}
                </h4>
                <p className="text-[10px] text-muted-foreground font-sans mt-1 leading-snug">
                  Continuous metric validation across thousands of drops.
                </p>
              </div>
            </div>
          ))}
